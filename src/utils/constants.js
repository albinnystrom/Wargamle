...
export const catTooltips = {
    ...
    speed: "Close if adjacent to the right result in a sorted list of possible speeds for units",
    autonomy:
    ...
    optics: "Close if adjacent to the right result in a sorted list of possible optics for units",
    stealth:
